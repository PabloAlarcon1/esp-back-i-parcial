...
public class CatalogService {
    ...
    private final MovieRepositoryFeign movieRepositoryFeign;
    private final ServiceRepositoryFeign serviceRepositoryFeign;

    public CatalogService(MovieRepository movieRepository, SeriesRepository seriesRepository, MovieRepositoryFeign movieRepositoryFeign, ServiceRepositoryFeign serviceRepositoryFeign) {
        this.movieRepository = movieRepository;
        this.seriesRepository = seriesRepository;
        this.movieRepositoryFeign = movieRepositoryFeign;
